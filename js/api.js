...
const getScorers = ()=>{
  ...
  .then(data => {
    ...
    data.scorers.forEach(scorer => {
      ...
      scorer.table.forEach(player => {
        scorerList += `
        <tr>
          <td class="center-align">${player.player.name}</td>
          <td class="center-align">${player.team.name}</td>
          <td class="center-align">${player.player.position}</td>
          <td class="center-align">${player.numberOfGoals}</td>
        </tr>
      `;
      })
